...
FROM (
		...
		LEFT JOIN (SELECT * FROM DBO.TABELA_PRECO_MEDIO('1', '2023-01-01', '2023-05-01', '3.0055', '3.0055')) AS TAB_PRECO_MEDIO ON (TAB_PRECO_MEDIO.IDPRD = T.IDPRD AND TAB_PRECO_MEDIO.CODCOLIGADA = '1')
