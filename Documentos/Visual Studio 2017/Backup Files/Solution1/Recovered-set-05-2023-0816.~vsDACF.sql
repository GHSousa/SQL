...
--CASE
--	  WHEN ITEM_ODC.QUANTIDADEARECEBER >0 THEN @STATUS--'PROGRAMADO' 
--	  WHEN ITEM_ODC.QUANTIDADEARECEBER = 0 THEN @STATUS --'RECEBIDO'
--	  WHEN ITEM_ODC.QUANTIDADEARECEBER < ITEM_ODC.QUANTIDADETOTAL THEN @STATUS--'PARCIALMENTE RECEBIDO'
--	  WHEN ITEM_ODC.QUANTIDADEARECEBER = ITEM_ODC.QUANTIDADETOTAL THEN @STATUS --'PENDENTE'
--	  END) 
