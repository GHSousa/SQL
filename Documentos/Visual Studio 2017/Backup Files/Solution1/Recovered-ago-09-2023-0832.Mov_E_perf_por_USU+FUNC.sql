...
--AND GUSUARIO.NOME LIKE '%eduardo%lacerda%' 
AND PFUNC.CODSITUACAO <>  'D'
AND TUSRTMV.CODUSUARIO IN  ('CELMA.ALMEIDA','CHRISTIANO.COSTA', 'EDVAR.SILVA', 'GABRIELA.FERREIRA', 'GIOVANNY.SANTOS', 'JULIANE.VIEIRA', 'LEONARDO.CORREA', 'MARCELO.NORONHA', 'RAFAEL.AZEVEDO', 'RODRIGO.CESAR', 'SABRINA.SALES', 'THIAGO.VIEIRA')
