...
(ISNULL(MOV_ODC.DATACRIACAO,(ISNULL(MOV_ORIGEM_CONT.DATACRIACAO,TMOV.DATACRIACAO)))) END)
 ...
 /* --- ALTERAÇÃO REALIZADA POR GABRIEL HIAGO. SOLITADAS POR GABRIEL TEIXEIRA NO CHAMADO 1123-000749 ---*/
 AND TORCAMENTO.CODCCUSTO IN (@CODCCUSTO)
 AND TMOVORCAMENTO.CODCOLIGADA IN (@CODCOLIGADA)
  /* --- ALTERAÇÃO REALIZADA POR GABRIEL HIAGO. SOLITADAS POR GABRIEL TEIXEIRA NO CHAMADO 1123-000749 ---*/
