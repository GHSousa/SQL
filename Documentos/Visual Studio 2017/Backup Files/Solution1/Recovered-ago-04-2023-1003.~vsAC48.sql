...
WHERE   
   ...
   ELSE TMOV.CODFILIAL END) ='1'
                ...
                AND (CASE WHEN TMOV.DATACRIACAO IS NULL 
                  THEN TMOV.DATACRIACAO ELSE TMOV.DATACRIACAO END) >= '2021-01-01'
        AND (CASE WHEN TMOV.DATACRIACAO IS NULL 
                  THEN TMOV.DATACRIACAO ELSE TMOV.DATACRIACAO END) <= '2023-08-02'
...
(CASE WHEN TMOV.DATACRIACAO IS NULL THEN TMOV.DATACRIACAO ELSE TMOV.DATACRIACAO END) >= '2021-01-01' AND
(CASE WHEN TMOV.DATACRIACAO IS NULL THEN TMOV.DATACRIACAO ELSE TMOV.DATACRIACAO END) <= '2023-08-02'
AND (TITMMOV.QUANTIDADE<>0
			OR TITMMOV.QUANTIDADETOTAL<>0)
...
(CASE WHEN TMOV.DATACRIACAO IS NULL THEN TMOV.DATACRIACAO ELSE TMOV.DATACRIACAO END) >= '2021-01-01' AND
(CASE WHEN CONVERT(DATE,TMOV.DATACRIACAO) IS NULL THEN CONVERT(DATE,TMOV.DATACRIACAO) ELSE  CONVERT(DATE,TMOV.DATACRIACAO) END) <= '2023-08-02'
