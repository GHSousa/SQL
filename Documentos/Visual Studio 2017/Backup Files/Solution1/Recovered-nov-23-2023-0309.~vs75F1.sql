DECLARE @DATA_INI_D AS DATE,
				@DATA_FIN_D AS DATE,
				@CCUSTO_FIN_S AS VARCHAR,
				@CCUSTO_INI_S AS VARCHAR;
SET @CCUSTO_INI_S = '1.0001.01'
SET @CCUSTO_FIN_S = '9.9999.99'
SET @DATA_INI_D = '20231117'
SET @DATA_FIN_D = '20231120'
...
AND		ODC.STATUS <> 'C'
AND		ODC.DATACRIACAO BETWEEN @DATA_INI_D AND @DATA_FIN_D
