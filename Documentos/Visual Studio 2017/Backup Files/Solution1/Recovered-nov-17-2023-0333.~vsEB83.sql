...
REPLACE (REPLACE (CONVERT (VARCHAR(MAX),(SELECT TOP 1 TMOVHISTORICO.HISTORICOLONGO FROM TMOVHISTORICO WHERE TMOVHISTORICO.IDMOV = ODC.IDMOV AND TMOVHISTORICO.CODCOLIGADA = ODC.CODCOLIGADA)),char(13) + char(10),' '),';',' ')AS HISTORICO_ODC,
...
INNER JOIN TCCOTACAO              (NOLOCK) ON (TCCOTACAOITMMOV.CODCOLIGADA = TCCOTACAO.CODCOLIGADA AND TCCOTACAOITMMOV.CODCOTACAO = TCCOTACAO.CODCOTACAO AND TCCOTACAO.STSCOTACAO <> 7)
...
AND		SOLICITACAO.DATACRIACAO BETWEEN '20230901' AND '20231116'
AND   ISNULL(TITMMOVRATCCU.CODCCUSTO,SOLICITACAO.CODCCUSTO) BETWEEN '1.0001' AND '9.9999'
...
AND		ODC.STATUS <> 'C'
AND		ODC.DATACRIACAO BETWEEN  '20230901' AND '20231116'
AND		ODC.CODCCUSTO BETWEEN '1.0001' AND '9.9999'
