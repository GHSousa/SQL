SELECT 
			...
			WHERE FLAN.CODCOLIGADA IN (31)--(@CODCOLIGADA) 
			AND FLANBAIXA.DATABAIXA BETWEEN '20230101' and '20231214'--@DATA_INI  AND @DATA_FIM
			AND CONVERT(VARCHAR,FLANCOMPL.COBRANCA) IN ('c0923')--(@COBRANCA)
