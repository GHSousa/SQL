...
DECLARE @DATA_PREENCIMENTO_INI  DATE;
DECLARE @DATA_PREENCIMENTO_FIN DATE;
DECLARE @OBRA VARCHAR(50);
DECLARE @LIBERADA BIT;

SET @DATA_PREENCIMENTO_INI = '20230101';
SET @DATA_PREENCIMENTO_FIN = '20231004';
SET @OBRA = 153;
SET @LIBERADA = 1;
