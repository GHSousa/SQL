...
AND TMOV_ODC.DATAENTREGA BETWEEN '2023-01-01' AND '2023-03-01'
AND TMOV.CODCOLIGADA IN ('1')
AND TITMMOV.QUANTIDADETOTAL > 0
AND (CASE
            WHEN TITMMOV.QUANTIDADEARECEBER > 0 THEN 'PROGRAMADO' 
            WHEN TITMMOV.QUANTIDADEARECEBER = 0 THEN 'RECEBIDO'
            WHEN TITMMOV.QUANTIDADEARECEBER < TITMMOV.QUANTIDADETOTAL THEN 'PARCIALMENTE RECEBIDO'
            WHEN TITMMOV.QUANTIDADEARECEBER = TITMMOV.QUANTIDADETOTAL THEN 'PENDENTE' 
			END) = ('PENDENTE')
