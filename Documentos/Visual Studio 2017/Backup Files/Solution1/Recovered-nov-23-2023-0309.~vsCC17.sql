...
SET @DATA_INI_CRIACAO_MOV ='20231101'
...
TMOVORCAMENTO.USUARIOCRIACAO 'ULTIMA EDIÇÃO DO MOVIMENTO',
--'CRIAÇÃO'
(ISNULL(MOV_ODC.USUARIOCRIACAO,(ISNULL(MOV_ORIGEM_CONT.USUARIOCRIACAO,TMOV.USUARIOCRIACAO)))) AS 'USUÁRIO CRIAÇÃO DO MOVIMENTO',

CONVERT(VARCHAR,DBO.DTORCAMENTO(TMOV.IDMOV,TMOVORCAMENTO.CODCOLIGADA,TORCAMENTO.CODCCUSTO),103) AS 'DATA AFETA ORÇAMENTO',

TPERIODOORCAMENTO.DESCRICAO AS 'DESCRIÇÃO ORÇAMENTO',
CONVERT (VARCHAR(2),MONTH(TITMPERIODOORCAMENTO.DATAINICIO)) + ' / ' + CONVERT(VARCHAR(4),YEAR(TITMPERIODOORCAMENTO.DATAINICIO)) AS 'PERIODO ORÇAMENTO',
...
(ISNULL(MOV_ODC.DATAEMISSAO,(ISNULL(MOV_ORIGEM_CONT.DATAEMISSAO,TMOV.DATAEMISSAO)))) AS 'DATA EMISSÃO',
